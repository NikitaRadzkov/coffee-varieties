...
describe('CoffeeExplorer', () => {
	it('should renders initial coffee data', async () => {
	...
	it('should loads more coffee data when "Load More Coffee" button is clicked', async () => {
		const mockData = { initialCoffee: null };
	...
	it('should shows error card when fetching fails', async () => {
